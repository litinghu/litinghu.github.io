...
<div markdown="0" id="carousel" class="carousel slide" data-ride="carousel" data-interval="5000" data-pause="hover" >
    ...
    <div class="carousel-inner" markdown="0">
        ...
        <div class="item active">
            <img src="{{ site.url }}{{ site.baseurl }}/images/slider7001400/class2018-1.jpg" alt="Slide 1" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/slider7001400/class2018-2.jpg" alt="Slide 2" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/slider7001400/class2019.jpg" alt="Slide 3" />
        </div>
    </div>
...
<figure class="fourth">
  ...
  <img src="{{ site.url }}{{ site.baseurl }}/images/logopic/NSF.png" style="width: 120px; margin-left: 13px">
  <img src="{{ site.url }}{{ site.baseurl }}/images/logopic/dod.svg" style="width: 107px; margin-left: 13px">
  <img src="{{ site.url }}{{ site.baseurl }}/images/logopic/meta.png" style="width: 140px; margin-left: 10px"><br>
  <img src="{{ site.url }}{{ site.baseurl }}/images/logopic/cf.png" style="width: 130px; margin-left: 20px">
  <img src="{{ site.url }}{{ site.baseurl }}/images/logopic/lyrasis.png" style="width: 102px; margin-left: 13px">
