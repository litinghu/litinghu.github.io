...
Our lab conducts <span style="font color='#DC143C'">**experimental computer systems research**</span> in the areas of <span style="font color='#DC143C'">**stream processing systems**</span>, <span style="font color='#DC143C'">**cloud and edge computing**</span>, <span style="font color='#DC143C'">**distributed systems**</span>, <span style="font color='#DC143C'">**machine learning**</span>, and <span style="font color='#DC143C'">**systems virtualization**</span>. Examples include stream processing systems (with Spark Streaming, Storm, Flink), identifying threats (e.g., fake news, rumors, social bots) in online social networks, developing machine learning techniques for systems, container as a service (with Docker and Kubernetes), and resource management in large-scale data centers (with Xen and KVM).
